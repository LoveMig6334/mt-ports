...
// Structural interface — both Project and CategoryWork satisfy this
export interface LightboxItem {
  id: string;
  title: string;
  description?: string;
  images: string[];
  category?: string; // shown in bottom-right when single image
}
...
export default function Lightbox({ item, onClose }: LightboxProps) {
  ...
  }, [onClose, navigate, canNavigate, lenis]);
